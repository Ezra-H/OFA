...
log_dir=./logs_large_fsdp_cpu_adam
save_dir=./checkpoints_large_fsdp_cpu_adam
...
for max_epoch in {20,}; do
  ...
  for lr in {2e-5,}; do
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch \
        ...
        --weight-decay=0.01 --optimizer=cpu_adam --adam-betas="(0.9,0.999)" --adam-eps=1e-08 --clip-norm=1.0 \
